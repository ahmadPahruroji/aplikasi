					...
					<li class="submenu">
                        <a href="#" class="active"><i class="fa fa-fw fa-image"></i> <span> Images and Galleries </span> <span class="menu-arrow"></span></a>
							<ul class="list-unstyled">
								...
								<li class="active"><a href="media-image-magnifier.html">Image Magnifier</a></li>
        ...
        <div class="content">
			...
			<div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-search"></i> Example 1</h3>								
							</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-search"></i> Eample 2</h3>								
							</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-search"></i> Example 3</h3>								
							</div>
			...
			<div class="alert alert-success" role="alert">
				  ...
				  <p>You can find examples and documentation about Bootstrap Image Magnify here: <a target="_blank" href="https://github.com/marcaube/bootstrap-magnify">Bootstrap Image Magnify</a></p>
			</div>
