        ...
        <div class="content">
			...
			<div class="row">
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">Alerts and Messages</h1>
			...
			<div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-bell-o"></i> Alerts examples</h3>
								Alerts are available for any length of text, as well as an optional dismiss button. For proper styling, use one of the eight required contextual classes (e.g., <i>.alert-success</i>). <a target="_blank" href="https://getbootstrap.com/docs/4.0/components/alerts/">(more details)</a>
							</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-bell-o"></i> Alerts witk links</h3>
								Use the <i>.alert-link</i> utility class to quickly provide matching colored links within any alert. (<a target="_blank" href="https://getbootstrap.com/docs/4.0/components/alerts/#link-color">more info</a>)
							</div>
			...
			<div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-bell-o"></i> Aditional content</h3>
								Alerts can also contain additional HTML elements like headings, paragraphs and dividers. <a target="_blank" href="https://getbootstrap.com/docs/4.0/components/alerts/#additional-content">(more info)</a>
							</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								<h3><i class="fa fa-bell-o"></i> Dismissing</h3>
								Using the alert JavaScript plugin, it’s possible to dismiss any alert inline. <a target="_blank" href="https://getbootstrap.com/docs/4.0/components/alerts/#dismissing">(more info)</a>
							</div>
