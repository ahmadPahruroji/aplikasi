	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
                        <a href="#" class="active"><i class="fa fa-fw fa-image"></i> <span> Images and Galleries </span> <span class="menu-arrow"></span></a>
							<ul class="list-unstyled">
								<li><a href="media-fancybox.html"><span class="label radius-circle bg-danger float-right">cool</span> Fancybox </a></li>								
								<li class="active"><a href="media-masonry.html">Masonry</a></li>
						...
						<div class="card mb-3">
							...
							<div class="card-body">
									 ...
									 <div class="grid">
										  ...
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/orange-tree.jpg" />
										  </div>
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/submerged.jpg" />
										  </div>
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/look-out.jpg" />
										  </div>
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/one-world-trade.jpg" />
										  </div>
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/drizzle.jpg" />
										  </div>
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/cat-nose.jpg" />
										  </div>
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/contrail.jpg" />
										  </div>
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/golden-hour.jpg" />
										  </div>
										  <div class="grid-item">
											<img alt="image" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/flight-formation.jpg" />
										  </div>
								    </div>
