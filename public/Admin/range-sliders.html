                    ...
                    <li class="submenu">
						<a href="#" class="active"><i class="fa fa-fw fa-th"></i> <span> Plugins </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
								...
								<li class="active"><a href="range-sliders.html">Range Sliders</a></li>
							...
							<div class="card-body">
								...
								<form class="form-horizontal">
                                        <div class="form-group row">
                                            <label for="range_slider_1" class="col-sm-2 col-xs-12 control-label"><b>Slider without paramenets</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_1">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_2" class="col-sm-2 col-xs-12 control-label"><b>Min, Max and Start value</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_2">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_3" class="col-sm-2 col-xs-12 control-label"><b>Prefix</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_3">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_4" class="col-sm-2 col-xs-12 control-label"><b>Range with negative values</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_4">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_5" class="col-sm-2 col-xs-12 control-label"><b>Steps</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_5">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_6" class="col-sm-2 col-xs-12 control-label"><b>Custom Values</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_6">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_7" class="col-sm-2 col-xs-12 control-label"><b>Prettify enabled</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_7">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_8" class="col-sm-2 col-xs-12 control-label"><b>Disabled (lock slider)</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_8">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_9" class="col-sm-2 col-xs-12 control-label"><b>Age Example</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_9">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_10" class="col-sm-2 col-xs-12 control-label"><b>Use decorate_both option</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_10">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_11" class="col-sm-2 col-xs-12 control-label"><b>Postfixes</b></label>
                                            <div class="col-sm-10 col-xs-12">
                                                <input type="text" id="range_slider_11">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="range_slider_12" class="col-sm-2 col-xs-12 control-label"><b>Hide labels</b></label>
                                            <div class="col-sm-10 col-xs-12">
