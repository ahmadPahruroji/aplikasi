...
class SpendingController extends Controller
{
    ...
    public function create()
    {
       ...
       // return view('adminmember/spending.create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('adminmember/spendings.index', $spending);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('adminmember/spendings.index');
    }
