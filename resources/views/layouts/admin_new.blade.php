...
<head>
	...
	<title>Dashboard E-Grasud</title>
		...
		<header class="header">
			<div class="logo-container">
				<a href="{{ route('home') }}" class="logo">
					<img src="{{ asset('octopus/assets/images/lg.png') }}" height="35" alt="JSOFT Admin" />
					<b>E-Graha Sudirman</b></a>
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						<figure class="profile-picture">
							<img src="{{ asset('octopus/assets/images/default.png') }}" alt="Joseph Doe" class="img-circle" data-lock-picture="{{ asset('octopus/assets/images/default.png') }}" />
						</figure>
						<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@JSOFT.com">
							<span class="name">Kelompok 4</span>
